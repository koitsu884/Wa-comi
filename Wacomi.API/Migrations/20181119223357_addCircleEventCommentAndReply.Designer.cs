...
namespace Wacomi.API.Migrations
{
    ...
    [Migration("20181119223357_addCircleEventCommentAndReply")]
    partial class addCircleEventCommentAndReply
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wacomi.API.Models.CircleEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CircleEvents");
                });

            modelBuilder.Entity("Wacomi.API.Models.CircleEventParticipation", b =>
                {
                    b.Property<int?>("AppUserId");

                    b.Property<int>("CircleEventId");
                    ...
                    b.HasKey("AppUserId", "CircleEventId");

                    b.HasIndex("CircleEventId");

                    b.ToTable("CircleEventParticipations");
                });
            ...
            modelBuilder.Entity("Wacomi.API.Models.Circles.CircleEventComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CircleEventComments");
                });

            modelBuilder.Entity("Wacomi.API.Models.Circles.CircleEventCommentReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CircleEventCommentReplies");
                });
            ...
            modelBuilder.Entity("Wacomi.API.Models.Notification", b =>
                {
                    ...
                    b.Property<string>("TargetRecordTitle");
            ...
            modelBuilder.Entity("Wacomi.API.Models.CircleEventParticipation", b =>
                {
                    b.HasOne("Wacomi.API.Models.AppUser", "AppUser")
                        .WithMany("CircleEventParticipations")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Wacomi.API.Models.CircleEvent", "CircleEvent")
                        .WithMany("CircleEventParticipations")
                        .HasForeignKey("CircleEventId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Wacomi.API.Models.Circles.CircleEventCommentReply", b =>
                {
                    ...
                    b.HasOne("Wacomi.API.Models.Circles.CircleEventComment", "Comment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Wacomi.API.Models.Photo", b =>
                {
                    ...
                    b.HasOne("Wacomi.API.Models.CircleEvent")
                        .WithMany("Photos")
                        .HasForeignKey("CircleEventId");
