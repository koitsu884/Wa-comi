...
namespace Wacomi.API.Controllers
{
    ...
    public class MemberController : AccountsController
    {
        ...
        public MemberController(IDataRepository repo, IMapper mapper) : base(repo, mapper){}
        ...
        public async Task<IActionResult> GetMember(int id){
           ...
           if(member == null)
            ...
            var memberToReturn = this._mapper.Map<MemberForReturnDto>(member);

            return new ObjectResult(memberToReturn);
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateMember(int id, [FromBody]MemberUpdateDto model){
            if(!ModelState.IsValid)
                return BadRequest(ModelState);
