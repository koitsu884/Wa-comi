...
export class PropertyEffects {
    ...
    updateProperty = this.actions$
        .ofType(PropertyActions.UPDATE_PROPERTY)
    ...
    setPropertySearchOptions = this.actions$
        .ofType(PropertyActions.SET_PROPERTY_SEARCH_OPTIONS)
        .map(() => {
            return {
    ...
    setClanSeekPagination = this.actions$
        .ofType(PropertyActions.SET_PROPERTY_PAGE)
        .map(() => {
            return {
                type: PropertyActions.SEARCH_PROPERTIES,
            }
    ...
    searchProperties = this.actions$
        .ofType(PropertyActions.SEARCH_PROPERTIES)
    ...
    getProperty = this.actions$
        .ofType(PropertyActions.GET_PROPERTY)
        .map((action: PropertyActions.GetProperty) => {
            return action.payload;
        })
        .switchMap((id) => {
            return this.httpClient.get<Property>(this.baseUrl + 'property/' + id)
                .map((result) => {
                    return {
