...
export class CircleManagementEffects {
    ...
    getMyCircleList = this.actions$
        .ofType(CircleManagementActions.GET_MY_CIRCLE_LIST)
        ...
        .switchMap((payload) => {
            ...
            return this.httpClient.get<Circle[]>(this.baseUrl + 'circle/user/' + payload.userId, { params: Params, observe: 'response' })
                .map((response) => {
                    return {
    ...
    getOwnCircleList = this.actions$
        .ofType(CircleManagementActions.GET_OWN_CIRCLE_LIST)
        ...
        .switchMap((payload) => {
            ...
            return this.httpClient.get<Circle[]>(this.baseUrl + 'circle/user/' + payload.userId + '/own', { params: Params, observe: 'response' })
                .map((response) => {
                    return {
    ...
    setMyCirclePagination = this.actions$
        .ofType(CircleManagementActions.SET_MY_CIRCLE_PAGE)
    ...
    setOwnCirclePagination = this.actions$
        .ofType(CircleManagementActions.SET_OWN_CIRCLE_PAGE)
